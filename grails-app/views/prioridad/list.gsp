    ...
    <!-- botones -->
            ...
            <tbody>
                <g:each in="${prioridadInstanceList}" status="i" var="prioridadInstance">
                    <tr data-id="${prioridadInstance.id}">
                        ...
                        <td>${fieldValue(bean: prioridadInstance, field: "descripcion")}</td>
        ...
        <script type="text/javascript">
            ...
            function deleteRow(itemId) {
                bootbox.dialog({
                    title   : "Alerta",
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>¿Está seguro que desea eliminar el Prioridad seleccionado? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",
