    ...
    <body>
        ...
        <div id="tipo" class="alert ">
            ...
            <div class="btn-group" data-toggle="buttons">
                <g:each var="tp" in="${seguridad.Tpac.list()}" status="i">
            ...
            <g:select optionKey="id" from="${seguridad.Prfl.list()}" name="perfil" value="${prflInstace?.id}" style="width: 180px;"/>
            </span>
        </div>
